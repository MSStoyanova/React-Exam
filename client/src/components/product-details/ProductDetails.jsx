            ...
            <div className="row">
                <div className="col-lg-5 mt-5">
                    <div className="card mb-3">
                        <img className="card-img img-fluid" src="/img/product_single_10.jpg" alt="Card image cap" id="product-detail"/>
                    </div>
                    <div className="row">
                        ...
                        <div className="card-body">
                            ...
                            <form action="" method="GET">
                                ...
                                <div className="row pb-3">
                                    ...
                                    <a href="/create-edit-product.html">EDIT</a>
                                        <button type="" className="btn btn-success btn-lg" name="submit" value="buy">Edit</button> 
                                    </div>
                                    <div className="col d-grid">
                                        <button type="" className="btn btn-success btn-lg" name="submit" value="addtocard">Delete</button>
                                    </div>
                                    <div className="col d-grid">
                                        <button type="" className="btn btn-success btn-lg" name="submit" value="addtocard">Like</button>
                                    </div> 
                                </div>
                            </form>
